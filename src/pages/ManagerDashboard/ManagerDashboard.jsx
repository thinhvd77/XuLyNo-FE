...
export default function ManagerDashboard() {
    ...
    }, [currentUser, currentPage, searchTerm, filterType, filterStatus, sortField, sortDirection, navigate]);
        ...
        <div className={styles.managerDashboard}>
            <div className={styles.pageHeader}>
                <div className={styles.headerContent}>
                    <h1>Hồ sơ phòng ban - {currentUser?.dept}</h1>
                    {currentUser && (
                        <div className={styles.summary}>
                            <span>Tổng số hồ sơ: <strong>{totalCases}</strong></span>
                            <span className={styles.departmentInfo}>
                                Phòng ban: <strong>{currentUser.dept}</strong> | 
